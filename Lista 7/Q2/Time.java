...
public class Time {
    ...
    public static Time diffTime(Time t1, Time t2)
    {
        ...
        if (t1.getTimeInSeconds() > t2.getTimeInSeconds())
            tdiff = t1.getTimeInSeconds() - t2.getTimeInSeconds();
        else
            tdiff = t2.getTimeInSeconds() - t1.getTimeInSeconds();
    ...
    public static Time diffTime(Time t1)
    {
        ...
        Time t2 = new Time(calendar.get(Calendar.HOUR_OF_DAY), calendar.get(Calendar.MINUTE), calendar.get(Calendar.SECOND));
