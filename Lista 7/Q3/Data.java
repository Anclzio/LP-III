...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static int howManyDaysUntilEndYear(Data outraData)
    {
        Data fimDoAno = new Data(31,12,outraData.getAno());
        return outraData.howManyDays(fimDoAno) * -1;
    }

    public static int howManyDaysUntilNextMonth(Data outraData)
    {
        int mes = outraData.getMes(), ano = outraData.getAno(), numDias = 31;
        if (mes == 2) {
        ...
        Data fimDoMes = new Data(numDias, mes, ano); 
        
        return outraData.howManyDays(fimDoMes) * -1;
    }
    ...
    public static String dayOfWeek(Data outraData)
    {
        return outraData.dayOfWeek();
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static boolean isBisexto(Data outraData)
    {
        int ano = outraData.getAno();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
        System.out.println(getDia()+" de " + Data.MesExtenso(getMes()) + " de " + getAno());
    }

    public static String dayToPrintShort(Data outraData)
    {
        return(outraData.getDia()+"/" + outraData.getMes() + "/" + outraData.getAno());
    }

    public static String dayToPrintLong(Data outraData)
    {
        return (outraData.getDia()+" de " + Data.MesExtenso(outraData.getMes()) + " de " + outraData.getAno());
    }
